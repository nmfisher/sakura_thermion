...
This runs `thermion_sakura_native/bin/render.dart` under `xvfb-run`
...
- Materials are compiled with the v1.75.0 Filament `matc` and embedded for the selected backends and embedded as single-line base64 in
